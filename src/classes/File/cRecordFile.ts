...
export default class CRecordFile extends CFile {
    protected validator: CValidator;
    protected uploader: CUploader;

    constructor(file: File) {
        super(file);
        this.validator = CValidatorFactory.create(FileType.Record);
        this.uploader = CUploaderFactory.create(FileType.Record);
    }
}
